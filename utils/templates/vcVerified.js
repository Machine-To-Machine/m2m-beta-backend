export const vcVerification = (url, uuid) => {
    // Sanitize inputs
    const safeUrl = String(url).replace(/[^\w\-.:\/]/g, '');
...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
 <head>
  ...
  <title>Machine to Machine - Verification Confirmed</title><!--[if (mso 16)]>
    <style type="text/css">
               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">You can see your Registry profile page here:&nbsp; <a href="${safeUrl}${safeUuid}" target="_blank" rel="noopener noreferrer">Click here</a></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
